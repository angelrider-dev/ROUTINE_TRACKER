    ...
    return tasksAsync.when(
      data: (allTasks) {
        ...
        return completionsAsync.when(
          ...
          error: (e, st) { debugPrint("Today screen tasks/completions error: $e\n$st"); return _ErrorBanner(message: "Couldn't load today's tasks: $e"); },
        );
      },
      loading: () => const _ListSkeleton(),
      error: (e, st) { debugPrint("Today screen tasks/completions error: $e\n$st"); return _ErrorBanner(message: "Couldn't load today's tasks: $e"); },
              ...
              tasksAsync.when(
                data: (allTasks) {
                  ...
                  return completionsAsync.when(
                    ...
                    error: (e, st) { debugPrint("Today screen progress error: $e\n$st"); return _ErrorBanner(message: "Couldn't load progress: $e"); },
                  );
                },
                loading: () => const _ProgressCardSkeleton(),
                error: (e, st) { debugPrint("Today screen progress error: $e\n$st"); return _ErrorBanner(message: "Couldn't load progress: $e"); },
